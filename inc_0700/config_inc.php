...
define('SUPPORT_EMAIL', 'daniel.calvin.douglas@gmail.com'); # Email of site support
...
$config->slogan = 'Yo fam this is Bootswatch theme!!';
...
$config->banner = 'List View, dawg.'; #goes inside header - can be overwritten
